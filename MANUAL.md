# Manual Setup Steps for Minions Retainers
...
Go to **GitHub → mxn2020/minions-retainers → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-retainers` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-retainers-web`
- **GitHub repo**: `mxn2020/minions-retainers`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `retainers.minions.wtf`

### Documentation
- **Netlify site name**: `minions-retainers-docs`
- **GitHub repo**: `mxn2020/minions-retainers`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `retainers.minions.help`

### Blog
- **Netlify site name**: `minions-retainers-blog`
- **GitHub repo**: `mxn2020/minions-retainers`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `retainers.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `retainers.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `retainers.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `retainers.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-retainers/sdk`](https://www.npmjs.com/package/@minions-retainers/sdk)
- CLI: [`@minions-retainers/cli`](https://www.npmjs.com/package/@minions-retainers/cli)
...
Your package: [`minions-retainers`](https://pypi.org/project/minions-retainers/)
...
| Item | Value |
|------|-------|
| Project | `minions-retainers` |
| SDK (npm) | `@minions-retainers/sdk` |
| CLI (npm) | `@minions-retainers/cli` |
| Python (PyPI) | `minions-retainers` |
| GitHub | `github.com/mxn2020/minions-retainers` |
| Docs domain | `retainers.minions.help` |
| Blog domain | `retainers.minions.blog` |
| App domain | `retainers.minions.wtf` |
